...
export default {
	...
	outputs: (_: { [x: string]: any; }) => {
		...
		const $webCss = $$$(
			...
			(css, normalize) => cleandAndMinifyCss(normalize + '\n' + css),
		);
		...
		const $resumePdfCss = $$$([_['CSS'], _['RESUME_CSS']], (cssFiles, rf) =>
			[
				normalizeDotCss,
				rf[
					'/Users/adam/Code/adamwong246.github.io/src/stylesheets/resume/resume.css'
				],
				rf[
					'/Users/adam/Code/adamwong246.github.io/src/stylesheets/resume/resume.pdf.css'
				],
		...
		const $resumeHtmlCss = $$$([_['CSS'], _['RESUME_CSS']], (cssFiles, rf) =>
			[
				...
				rf[
					'/Users/adam/Code/adamwong246.github.io/src/stylesheets/resume/resume.html.css'
				],
				// Only include the resume-specific styles, not the full typography.css which has many font references
			].join('\n'),
		);
